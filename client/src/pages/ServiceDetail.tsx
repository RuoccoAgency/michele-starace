...
import { ChevronLeft, CheckCircle2, Phone, Calendar } from "lucide-react";
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
            ...
            >
              ...
              <div className="mt-16 flex flex-col sm:flex-row gap-4">
                <Link href="/#contatti">
                  <Button className="bg-primary text-black hover:bg-white transition-all duration-300 font-black h-16 px-12 rounded-full text-sm tracking-widest uppercase flex items-center gap-2 shadow-2xl shadow-primary/20">
                    <Calendar className="w-5 h-5" />
                    Prenota Appuntamento
                  </Button>
                </Link>
                <Link href="tel:+390818711000">
                  <Button variant="outline" className="border-white/20 text-white hover:bg-white/10 font-black h-16 px-12 rounded-full text-sm tracking-widest uppercase flex items-center gap-2">
            ...
            >
              ...
              <img
                ...
                onError={(e) => {
                  ...
                  img.src = `https://images.unsplash.com/photo-${getImageIdForService(service.id)}?auto=format&fit=crop&q=80`;
                }}
              />
